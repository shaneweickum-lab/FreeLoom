 ...
 * live via Realtime so it appears and disappears immediately -- an
 * approval, an extension, an early close-out, or a natural expiry all
 * show up here with no refresh. */
